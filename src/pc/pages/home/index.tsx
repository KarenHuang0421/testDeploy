...
import NoFollowing from "../../../common/components/no-following";
import { demoFeed } from "../../../data.json";
...
export default function Home() {
	...
	return (
		<PageWithSidebar className="homepage-container" isHome>
			<div className="content-container">
				{feed?.length === 0 && <NoFollowing />}
				{/* {!feed ? (
					<LoadingSpinner />
				) : (
					<InfiniteScroll
