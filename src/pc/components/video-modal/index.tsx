...
import { demoComments } from "../../../data.json";
import { ReactComponent as ReplySmIcon } from "../../../assets/reply-sm-icon.svg";
import { ReactComponent as KeepSmIcon } from "../../../assets/keep-sm-icon.svg";
			...
			{!isFullScreen && (
					...
					<div className="modal-top">
						...
						/> */}
							...
							<div className="names">
								...
								<h4>
									{/* {props.uploader!.name} |&nbsp; */}
									<span>發佈於 {convertToDate(props.createdAt!)}</span>
								</h4>
							</div>
							{/* <UserDropdown
						username={props.uploader!.username!}
				...
				<div className="view-count" title="Views">
					<i className="fas fa-eye" /> {props.views}
						...
						<div className={joinClasses("d-row", "url-copy-section")}>
							<Input
								type="text"
								id="url"
